#!/bin/bash
#SBATCH --job-name=SPLIT_CQR_Year3
...
#SBATCH --output=/home/otd8990/logs/SPLIT_CQR_Year3.out
#SBATCH --error=/home/otd8990/logs/SPLIT_CQR_Year3.err
